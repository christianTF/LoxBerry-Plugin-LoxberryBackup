...
echo "<INFO> LoxBerry Backup Plugin makes sure everything is encoded in Unix style (running dos2unix)..."
find /tmp/uploads/$ARGV1 -type f -print0 | xargs -0 dos2unix -q 
echo "<INFO> dos2unix has finished"
echo "<INFO> LoxBerry Backup Plugin prepares dir and name variables (running sed)..."
